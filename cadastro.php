                    ...
                    <div class="card-body border">
                        <form method="post" action="">
                                    ...
                                    <select name="perfil" type="text" class="form-select">
                                        ...
                                        <option <?php
                                                if ($pe->getPerfil() == "Cliente") {
                                                    //posso colocar null aonde está escrito Cliente
                                                    echo "selected = 'selected'";
                                                } ?>>Cliente</option>
                                        <option <?php
                                                if ($pe->getPerfil() == "Funcionário") {
                                                    //posso colocar null aonde está escrito Funcionário
                                                    echo "selected = 'selected'";
                                                } ?>>Funcionário</option>
                            ...
                            <div class="col-6 offset-4">
                                ...
                                &nbsp;&nbsp;
                                <input type="submit" name="atualizar" class="btn btn-secondary btInput" value="Atualizar" <?php if ($btAtualizar == FALSE) echo "disabled"; ?>>
                            </div>
                        </form>
                    </div>
                </div>
                    ...
                    <tbody>
                        ...
                        ?>
                                <tr>
                                    ...
                                    <td><a href="cadastro.php?id=<?php echo $lp->getIdPessoa(); ?>" class="btn btn-light">
